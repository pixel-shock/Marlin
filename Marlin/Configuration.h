...
#define STRING_CONFIG_H_AUTHOR "(Tino Wehe 2022-09-29)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Tinos CR10s Pro V2 SKR 3.0EZ V1"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.80, 81.75, 403.47, 139.19 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -27, 0, -1.33 }
