...
#define STRING_CONFIG_H_AUTHOR "(Tino Wehe 2022-09-04)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Tinos CR10s Pro V2 SKR 1.4"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.20, 81.32, 400.80, 140.46 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -27, 0, -1.25 }
